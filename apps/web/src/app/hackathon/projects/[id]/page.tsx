  ...
  return <PublicInteractionBoundary><main className="detail-page mx-auto w-full max-w-[1440px] px-5 py-8 sm:px-8 lg:px-16">
    ...
    <div className="detail-layout mt-12">
      ...
      <aside className="detail-aside">
        ...
        {project.demoLink ? <div className="detail-demo"><iframe className="h-[620px] w-full bg-white" src={project.demoLink} title={`${project.name} Demo`} /></div> : <div className="showcase-empty">暂无 Demo 链接</div>}
